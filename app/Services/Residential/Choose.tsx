...
const Choose = () => {
  const data = [
    { icon: "/Interior-Media/icons/guru.png", name: "Expertise & Innovation" },
    {
    ...
    },
    {
      ...
      name: "End-to-end Design Solutions",
    },
    {
  ...
  return (
    <div className="mt-20">
      <div className="container">
        ...
        <div className="grid mt-10 grid-cols-4 gap-4 place-items-center">
          {data.map((e, idx) => (
            <div
              key={idx}

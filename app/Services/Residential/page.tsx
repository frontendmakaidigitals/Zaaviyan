  ...
  return (
    <main className="">
      <div className="relative">
        <div className="w-[500px] absolute right-0 -z-10 bottom-10  h-[400px] bg-slate-100">
          <img
            src={
        ...
        <div className="grid h-[750px] relative container place-items-center grid-cols-1 lg:grid-cols-2 gap-4">
          ...
          <div className="w-full h-full flex items-center absolute max-w-[750px] right-10 -z-10">
            <motion.img
              src={
